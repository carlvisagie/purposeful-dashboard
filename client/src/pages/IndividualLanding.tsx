            ...
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  description:
                    "From $49/month. No expensive therapy bills. No insurance hassles.",
                },
              ].map((feature, idx) => (
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                price: "$49",
                period: "/month",
                description: "Daily support & coaching",
                features: [
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                a: "Yes. No contracts. No hidden fees. Cancel your subscription anytime.",
              },
              {
